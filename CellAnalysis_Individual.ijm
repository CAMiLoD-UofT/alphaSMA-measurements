// Detect alphaSMA coherency and intensity levels based on cell shape as determined by the phalloidin staining
// By Joao Firmino, PhD
// v1.0
...
function processFile(input, output, file) {
	...
	// we now proceed to identify all ROIs with an area between 5000 and infinite micron^2 - this is the only step where the user induces some bias!!
	run("Analyze Particles...", "size=5000-Infinite add");
